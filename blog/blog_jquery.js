$(document).ready(function(){
  ...
  $modify = ("<p>Every week I go to my website and publish a new blog for the week, when I get to my site I always say \"yuck\".  At the time I was proud of my effort because I was working my business more then doing the homework necessary to actually execute my work in a timely manner so my expectations where low.  I did welcome this challenge but I also know that this is a time consuming proposal so I tackled it like this...<br><br>I used a template from the Jon Duckett book and when from there.  Did this help or hurt.  I will say this…at this point it is all a learning experience and it helped me understand what I don’t like.  After learning a little bit about atomic styling and using a grid template - that is what I will do in the future. I did want to spend more time learning about jQuery so the time saved by getting a head start with the HTML was great.  It was also interesting to modify the CSS to see how things were changing - seeing if I knew exactly what would change before the refresh.<br><br>I like my site for now.  I couldn’t get the functionality of my jQuery to operate the way I would like so \"site maintenance\" is in my very near future.</p>");

  $("#blog_content9").click(function() {
      $(this).after($modify);
  });
 ...
 $question = ("<p>At this point in my programming venture I know I am in need of the \"Golden Rule\" (imagine you’re trying to answer the question).  When I was in gps and I was asked to explain what was the code doing I fumbled and bumbled my way through.  The instructor told me \"to not use the word it\".  If I had to use the word \"it\" then I needed to find out what \"it\" was before explaining what \"it\" was doing.  Point taken and I feel it is the same for asking a question.  You need to know names of the items your are referring to so you can communicate them to someone else.  Personally, I am terrible at this and in the coming weeks will take time to stop and imagine I am trying to answer the question.  My brain goes along faster then the words are formulated and spoken, so I find myself concentrating on the thinking instead of the speaking - I will try to just stay in the moment.</p>");

  $("#blog_cult8").click(function() {
      $(this).after($question);
  });
